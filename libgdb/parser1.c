...
test_packet_ack(void)
{
	...
	pkt = parse_file("testdata/parser1/ack.dat");
...
test_packet_nack(void)
{
	...
	pkt = parse_file("testdata/parser1/nack.dat");
...
test_packet_simple(void)
{
	...
	pkt = parse_file("testdata/parser1/simple.dat");
...
test_packet_notify(void)
{
	...
	pkt = parse_file("testdata/parser1/notify.dat");
